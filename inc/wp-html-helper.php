...
// image default alt
if( ! function_exists( 'sneakyrestaurant_img_default_alt' ) ) {
	function sneakyrestaurant_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'sneakyrestaurant_img_tag' ) ) {
	function sneakyrestaurant_img_tag( array $args ) {
		...
		if( ! empty( $args['alt'] ) ) {
			...
			$alt = sneakyrestaurant_img_default_alt( $url );
		}
...
// Anchor Tag
if( ! function_exists( 'sneakyrestaurant_anchor_tag' ) ) {
	function sneakyrestaurant_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'sneakyrestaurant' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'sneakyrestaurant_heading_tag' ) ) {
	function sneakyrestaurant_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'sneakyrestaurant' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'sneakyrestaurant_paragraph_tag' ) ) {
	function sneakyrestaurant_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'sneakyrestaurant_other_tag' ) ) {
	function sneakyrestaurant_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'sneakyrestaurant_button_element ' ) ) {
	function sneakyrestaurant_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'sneakyrestaurant' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
