 ...
 * @since 1.0
 */
class sneakyrestaurant_sh extends Widget_Base {

	public function get_name() {
		return 'sneakyrestaurant-sh';
	}

	public function get_title() {
		return __( 'Section Heading', 'sneakyrestaurant' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'sh_content',
            [
                'label' => __( 'Section Heading', 'sneakyrestaurant' ),
            ]
        );
        $this->add_control(
            'sh_sectiontitle',
        ...
        $this->start_controls_section(
            'style_section', [
                'label' => __( 'Style Section', 'sneakyrestaurant' ),
