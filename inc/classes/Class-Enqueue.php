...
class sneakyrestaurant_Enqueue {

	public $scripts = array();

	public function sneakyrestaurant_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'sneakyrestaurant_frontend_enqueue_scripts', ) );
	}

	public function sneakyrestaurant_frontend_enqueue_scripts( ) {
